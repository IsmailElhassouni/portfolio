            ...
            <h2 className="text-3xl font-bold mb-8 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent text-center"> Feature Projects </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <p className="text-gray-300 mb-4">
                        A real-time multiplayer Pong game with chat and social features.<br />
                        Built with TypeScript on both frontend and backend using Fastify and Prisma.<br />
                        Implemented WebSocket for gameplay and messaging, and used Docker for DevOps and deployment.<br />
                        Integrated google OAuth authentication with user profiles and matchmaking.
                        <br />Check out the code on <a className="text-blue-500" href="https://github.com/IsmailElhassouni/ft_transencde">GitHub</a>
                    </p>
                    <div className="flex flex-wrap gap-2 mb-4">
                    {["TypeScript", "Fastify", "Prisma", "WebSocket", "SPA"].map((skill, index) => (
                       <span
                       key={index}
